...
export class Assignment3 extends Scene {
    constructor() {
        ...
        this.shapes = {
            ...
            //        (Requirement 1)
            planet_1: new defs.Subdivision_Sphere(2),
        };
        ...
        this.materials = {
            ...
            //        (Requirement 4)
            planet_1: new Material(new Gouraud_Shader(),
                {ambient: .7, specularity:.3, diffusivity: .8, color: hex_color("#bababa")}),
        }
    ...
    display(context, program_state) {
        ...
        if (!context.scratchpad.controls) {
            ...
            if(matrix === this.initial_camera_location){
                ...
                matrix = matrix.times(Mat4.translation(0, 0, 10));
        ...
        this.planet_1 = model_transform_p1.map( (x,i) => Vector.from( program_state.camera_transform[i] ).mix( x, 0.3) );
    }
}
